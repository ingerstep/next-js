    ...
    >
      ...
      >
        <button
          onClick={onClose}
          className={clsx(
            "w-8 h-8 rounded absolute top-0 left-[calc(100%+12px)]",
...
UiModal.Body = function UiModalHeader({ className, children }) {
  return <div className={clsx(className, "px-6")}>{children}</div>;
};

UiModal.Footer = function UiModalHeader({ className, children }) {
  return (
